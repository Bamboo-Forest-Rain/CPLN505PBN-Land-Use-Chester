...
```
Just by log transforming, even without variable selection, the model has a reduced AIC by 200. 
...
## 1 in both REGRAIL300 and CITBORO_10
POV_possibility <- data.frame(PCT_POV_90 = Chester_L_Final$PCT_POV_90, REGRAIL300 = 1, CITBORO_10 = 1,POPDEN90 = mean(Chester_L_Final$POPDEN90), MEDHSEVAL_ = mean(Chester_L_Final$MEDHSEVAL_), PCT_WHITE_ = mean(Chester_L_Final$PCT_WHITE_), PCT_SFHOME = mean(Chester_L_Final$PCT_SFHOME), DIST_PASSR = mean(Chester_L_Final$DIST_PASSR, na.rm = TRUE), DIST_4LNE_ = mean(Chester_L_Final$DIST_4LNE_,na.rm = TRUE), DIST_PARKS = mean(Chester_L_Final$DIST_PARKS,na.rm = TRUE), DIST_WATER = mean(Chester_L_Final$DIST_WATER,na.rm = TRUE))

POV_possibility <-
  POV_possibility %>%
  mutate(predict_result = predict(bi_model3,POV_possibility,type = "response"))

## 0 in both REGRAIL300 and CITBORO_10
POV_possibility2 <- data.frame(PCT_POV_90 = Chester_L_Final$PCT_POV_90, REGRAIL300 = 0, CITBORO_10 = 0,POPDEN90 = mean(Chester_L_Final$POPDEN90), MEDHSEVAL_ = mean(Chester_L_Final$MEDHSEVAL_), PCT_WHITE_ = mean(Chester_L_Final$PCT_WHITE_), PCT_SFHOME = mean(Chester_L_Final$PCT_SFHOME), DIST_PASSR = mean(Chester_L_Final$DIST_PASSR, na.rm = TRUE), DIST_4LNE_ = mean(Chester_L_Final$DIST_4LNE_,na.rm = TRUE), DIST_PARKS = mean(Chester_L_Final$DIST_PARKS,na.rm = TRUE), DIST_WATER = mean(Chester_L_Final$DIST_WATER,na.rm = TRUE))

POV_possibility2 <-
  POV_possibility2 %>%
  mutate(predict_result = predict(bi_model3,POV_possibility2,type = "response"))

## REGRAIL300 = 0 and CITBORO_10 = 1
POV_possibility3 <- data.frame(PCT_POV_90 = Chester_L_Final$PCT_POV_90, REGRAIL300 = 0, CITBORO_10 = 1,POPDEN90 = mean(Chester_L_Final$POPDEN90), MEDHSEVAL_ = mean(Chester_L_Final$MEDHSEVAL_), PCT_WHITE_ = mean(Chester_L_Final$PCT_WHITE_, na.rm = TRUE), PCT_SFHOME = mean(Chester_L_Final$PCT_SFHOME), DIST_PASSR = mean(Chester_L_Final$DIST_PASSR, na.rm = TRUE), DIST_4LNE_ = mean(Chester_L_Final$DIST_4LNE_,na.rm = TRUE), DIST_PARKS = mean(Chester_L_Final$DIST_PARKS,na.rm = TRUE), DIST_WATER = mean(Chester_L_Final$DIST_WATER,na.rm = TRUE))

POV_possibility3 <-
  POV_possibility3 %>%
  mutate(predict_result = predict(bi_model3,POV_possibility3,type = "response"))

## REGRAIL300= 1 and CITBORO_10 = 0
POV_possibility4 <- data.frame(PCT_POV_90 = Chester_L_Final$PCT_POV_90, REGRAIL300 = 1, CITBORO_10 = 0,POPDEN90 = mean(Chester_L_Final$POPDEN90), MEDHSEVAL_ = mean(Chester_L_Final$MEDHSEVAL_),PCT_WHITE_ = mean(Chester_L_Final$PCT_WHITE_), PCT_SFHOME = mean(Chester_L_Final$PCT_SFHOME), DIST_PASSR = mean(Chester_L_Final$DIST_PASSR, na.rm = TRUE), DIST_4LNE_ = mean(Chester_L_Final$DIST_4LNE_,na.rm = TRUE), DIST_PARKS = mean(Chester_L_Final$DIST_PARKS,na.rm = TRUE), DIST_WATER = mean(Chester_L_Final$DIST_WATER,na.rm = TRUE))

POV_possibility4 <-
  POV_possibility4 %>%
  mutate(predict_result = predict(bi_model3,POV_possibility4,type = "response"))

#Combing the results in a new data frame
POV_PRE <- data.frame(PCT_POV = POV_possibility$PCT_POV_90, PRED_REGandCITY_Both1 = POV_possibility$predict_result, PRED_REGandCITY_Both0 = POV_possibility2$predict_result, PRED_REG0_CITY1 = POV_possibility3$predict_result, PRED_REG1_CITY0 = POV_possibility4$predict_result)

#Arrange the data by scenario
dat <- gather(POV_PRE, -PCT_POV, key = "Scenario", value = "value")

#Plot the data 
ggplot(dat, aes(x = PCT_POV, y = value, colour = Scenario)) + 
