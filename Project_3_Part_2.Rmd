...
dat_final <-
  dat2 %>%
  select("SAMPN.x", "PERNO.x", "X", "AGE", "INCOME", "SAMPN_PER", "with_toll", "TOLL", "with_park", "PARKU","PARKO" ,"TRPDUR", "drove_work", "transit_work","carpool_work", GEND, DISAB, EDUC, TOTVEH, ADVLT, RENT, ENGL , HHSIZE, NPHON , NOWRK, starts_with("time"),mode)
...
We selected variables that are relevant across all modes (i.e. toll or parking are only related to driving, so we excluded them).
