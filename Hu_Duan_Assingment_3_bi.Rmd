...
```
According to the new model, the most important factors that explains the land use change between 1992 and 2001 are, from greatest to least, 1) if the location has an household poverty below 4%, 2)if the location has an white population below 97%, 3) if the location is located within 300 meters of a SEPTA railway, and 4) if the location is within 1000 meters of city and boro. These four factors have the largest impact on the possibility of a location being urbanized. 
