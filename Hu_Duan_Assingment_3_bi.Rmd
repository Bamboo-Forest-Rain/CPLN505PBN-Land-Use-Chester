...
The AIC is shown to be 1451 with very few significant variables. A backward and forward selection methods are used to give a list of the most related variables. Some variables returned NA in the model, which means they are co-linear with other variables. These variables should be removed. 
